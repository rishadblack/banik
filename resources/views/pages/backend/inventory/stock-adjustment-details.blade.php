...
<div>
    <div class="d-flex align-items-center mb-3">
        <x-slot:title>Stock Adjustment Details</x-slot:title>
    </div>
    <div class="row gx-4">
        <div class="col-xl-8">
            ...
            <x-layouts.backend.card class="payment-info">
                ...
                <x-slot:title>Stock Adjustment Item</x-slot:title>
                <div class="row ">
        ...
        <div class="col-xl-4">
            <x-layouts.backend.card>
                ...
                <x-slot:button>
                    <div class="dropdown">
                        <x-button.default wire:click="storeStockAdjustment"
                            class="btn-success">{{ $stockadjustment_id ? 'Update' : 'Create' }}</x-button.default>
                ...
                <x-input.select wire:model="warehouse" label="Warehouse">
                    <option value="1">Sonargau</option>
                    <option value="2">Paltan</option>
                </x-input.select>
                <x-input.text wire:model="damage" label="Damage/Adjust" />
