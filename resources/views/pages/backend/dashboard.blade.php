        ...
        <div class="col-xl-6 mb-3">
            ...
            <div class="card h-100 overflow-hidden">
                ...
                <div class="card-img-overlay d-none d-md-block bg-blue rounded mb-n1 mx-n1"
                    style="background-image: url(backend/assets/img/bg/wave-bg.png); background-position: right bottom; background-repeat: no-repeat; background-size: 100%;">
                </div>
                ...
                <div class="card-img-overlay d-none d-md-block bottom-0 top-auto">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xl-6 mb-n2">
                            <img src="{{ asset('backend/assets/img/page/dashboard.svg') }}" alt
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange"
                        ...
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{ asset('backend/assets/img/icon/order.svg') }}" alt
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div><a href="#"
                                    ...
                                    report <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal"
                        ...
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{ asset('backend/assets/img/icon/visitor.svg') }}" alt
                                class="ms-auto d-block mb-n3" style="max-height: 105px">
                        </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink"
                        ...
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{ asset('backend/assets/img/icon/email.svg') }}" alt
                                class="ms-auto d-block mb-n3" style="max-height: 105px">
                        </div>
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
                        ...
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{ asset('backend/assets/img/icon/browser.svg') }}" alt
                                class="ms-auto d-block mb-n3" style="max-height: 105px">
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-center">
                                    <div
                                        class="w-50px h-50px bg-primary bg-opacity-20 rounded-circle d-flex align-items-center justify-content-center mb-2 ms-auto me-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div
                            ...
                            <img src="{{ asset('backend/assets/img/product/product-1.jpg') }}" alt
                                class="ms-100 mh-100">
                        </div>
                        <div class="flex-grow-1">
                            <div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div
                            class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
                            <img src="{{ asset('backend/assets/img/product/product-2.jpg') }}" alt
                                class="ms-100 mh-100">
                        </div>
                        <div class="flex-grow-1">
                            <div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div
                            class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
                            <img src="{{ asset('backend/assets/img/product/product-3.jpg') }}" alt
                                class="ms-100 mh-100">
                        </div>
                        <div class="flex-grow-1">
                            <div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div
                            class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
                            <img src="{{ asset('backend/assets/img/product/product-4.jpg') }}" alt
                                class="ms-100 mh-100">
                        </div>
                        <div class="flex-grow-1">
                            <div>
                    ...
                    <div class="d-flex align-items-center">
                        <div
                            class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
                            <img src="{{ asset('backend/assets/img/product/product-5.jpg') }}" alt
                                class="ms-100 mh-100">
                        </div>
                        <div class="flex-grow-1">
                            <div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="w-40px h-40px">
                                                <img src="{{ asset('backend/assets/img/icon/paypal2.svg') }}" alt
                                                    class="ms-100 mh-100">
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="w-40px h-40px rounded">
                                                <img src="{{ asset('backend/assets/img/icon/mastercard.svg') }}" alt
                                                    class="ms-100 mh-100">
                                            </div>
                                            <div class="ms-3 flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="w-40px h-40px rounded">
                                                <img src="{{ asset('backend/assets/img/icon/visa.svg') }}" alt
                                                    class="ms-100 mh-100">
                                            </div>
                                            <div class="ms-3 flex-grow-1">
